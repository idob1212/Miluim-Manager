...
class CreateReviewForm(FlaskForm):
    ...
    last_flight_date = DateField("תאריך טיסה",render_kw={'max':date.today() + timedelta(1)},validators=[DataRequired("זהו סעיף חובה")])
...
class RegisterForm(FlaskForm):
    ...
    last_15_date = DateField("כוננות 15' אחרונה", render_kw={'max':date.today() + timedelta(1)}, validators=[DataRequired("זהו סעיף חובה")])
    last_flight_date = DateField("תאריך טיסה אחרונה ", render_kw={'max':date.today() + timedelta(1)}, validators=[DataRequired("זהו סעיף חובה")])
